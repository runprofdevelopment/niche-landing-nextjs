import { DesignerApp, EventPageShell } from "@/features/events";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createEventPageMetadata(t("hallDesigner"), "hallDesignerDescription");
}
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <EventPageShell fill>
      <DesignerApp eventId={eventId} hallId={hallId} />
    </EventPageShell>
  );
}
