import { EventPageShell, SeatingApp } from "@/features/events";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createEventPageMetadata(t("seatingAssignment"), "seatingAssignmentDescription");
}
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <EventPageShell fill>
      <SeatingApp eventId={eventId} hallId={hallId} />
    </EventPageShell>
  );
}
